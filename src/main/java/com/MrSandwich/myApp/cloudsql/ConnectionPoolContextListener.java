...
public class ConnectionPoolContextListener implements ServletContextListener {
    ...
    private static final String CLOUD_SQL_CONNECTION_NAME =
            System.getenv("mrsandwich:europe-west3:mr-sandwich");
    private static final String DB_USER = System.getenv("root");
    private static final String DB_PASS = System.getenv("Widzew!2");
    private static final String DB_NAME = System.getenv("MrSandwich");
    ...
    private DataSource createConnectionPool() {
        ...
        // https://gith+-90ub.com/GoogleCloudPlatform/cloud-sql-jdbc-socket-factory#creating-the-jdbc-url
